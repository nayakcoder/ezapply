  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center py-16">
        <div className="w-full max-w-2xl px-8 py-12 bg-white rounded-xl shadow-sm mb-16">
          <div className="mb-6">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600 mt-2">Get started with your overseas university application</p>
          </div>
